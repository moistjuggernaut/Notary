...
class StripeConfig(BaseSettings):
    ...
    secret_key: str = Field(default="", env="STRIPE_SECRET_KEY")
    price_id: str = Field(default="", env="STRIPE_PRICE_ID")
    webhook_secret: str = Field(default="", env="STRIPE_WEBHOOK_SECRET")
    public_base_url: str = Field(default="", env="APP_PUBLIC_BASE_URL")
